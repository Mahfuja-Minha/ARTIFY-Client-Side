    ...
    <div className="min-h-[calc(100vh-20px)] flex items-center justify-center">
      <div className="flex flex-col items-center gap-10 p-8 lg:p-10">
        <div className="max-w-lg text-center">
          <h1 className="text-4xl md:text-5xl font-extrabold text-[#7C3AED]">
            Welcome Back
          </h1>
          <p className="mt-4 text-lg text-base-content">
            Sign in to access your account and continue exploring Artify.
          </p>
        </div>
  ...
  shadow-xl rounded-2xl p-8 backdrop-blur-lg"
        >
          ...
          <form onSubmit={handleSignIn} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full py-2 rounded-lg bg-[#7C3AED] hover:bg-[#6D28D9] text-white font-semibold"
            >
              Login
            </button>
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 border border-[#7C3AED] text-[#7C3AED] px-5 py-2 rounded-lg w-full font-semibold hover:bg-base-200"
            >
              <img
